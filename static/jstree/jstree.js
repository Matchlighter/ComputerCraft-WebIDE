 ...
 */
	...
	$.jstree.core.prototype = {
		...
		redraw_node : function (node, deep, is_callback) {
			...
			this.trigger('redraw_node', {'node': node,});
			return node;
		},
		/**
						...
						$.each(state.core.open.concat([]), function (i, v) {
							...
							if(n) {
								if(t.is_loaded(v)) {
									...
									if(!t.is_loading(v)) {
										t.open_node(v, $.proxy(function (node, success) {
											if (success) {
												this.set_state(state, callback);
											}
										}, t), 0);
		...
		this.bind = function () {
			...
			this.element
				.on("ready.jstree", $.proxy(function (e, data) {
						if (!options.force_init) {
							this.element.one("restore_state.jstree", bind);
						}
						if(!this.restore_state() || options.force_init) {
							bind();
						}
					}, this));
		};
